...
(function (t) {
  ...
  function s(e) {
    function n(n, i) {
      t.isPlainObject(i) && t.isPlainObject(e[n]) && !o(n)
        ? (e[n] = s({}, e[n], i))
        : void 0 !== i && (e[n] = i);
    }
  ...
  function l(n, i) {
    ...
    function l() {
      (ie = K.theme ? "ui" : "fc"),
        n.addClass("fc"),
        K.isRTL ? n.addClass("fc-rtl") : n.addClass("fc-ltr"),
        K.theme ? n.addClass("ui-widget") : n.addClass("fc-unthemed"),
        (ne = t("<div class='fc-view-container'/>").prependTo(n)),
        (te = new a(q, K)),
        (ee = te.render()),
        ee && n.prepend(ee),
        h(K.defaultView),
        K.handleWindowResize &&
          ((oe = _(v, K.windowResizeDelay)), t(window).resize(oe));
    }
    function d() {
      re && re.destroy(),
        te.destroy(),
    ...
    function f(e, n) {
      ue++,
        ...
        !re &&
          n &&
          ((re = new Ge[n](q)),
          (re.el = t("<div class='fc-view fc-" + n + "-view' />").appendTo(ne)),
          te.activateButton(n)),
        re &&
    ...
    function m() {
      se =
        "number" == typeof K.contentHeight
          ...
          : Math.round(ne.width() / Math.max(K.aspectRatio, 0.5));
    }
    function v(t) {
      !ue &&
        t.target === window &&
    ...
    function Y(t, e) {
      ...
      (e && void 0 !== Ge[e]) ||
        ((e = e || "day"),
        (n = te.getViewsWithButtons().join(" ")),
        (i = n.match(RegExp("\\w+" + z(e)))),
        i || (i = n.match(/\w+Day/)),
        (e = i ? i[0] : "agendaDay")),
        (le = t),
        h(e);
    ...
    var U,
      K = s({}, Fe, i);
    (U = K.lang in Le ? Le[K.lang] : Le[Fe.lang]),
      U && (K = s({}, Fe, U, i)),
      K.isRTL && (K = s({}, Fe, ze, U || {}, i)),
      (q.options = K),
      (q.render = o),
      (q.destroy = d),
      (q.refetchEvents = y),
    ...
    (q.defaultAllDayEventDuration = e.duration(K.defaultAllDayEventDuration)),
      ...
      (q.moment = function () {
        ...
        return (
          "local" === K.timezone
            ? ((t = _e.moment.apply(null, arguments)), t.hasTime() && t.local())
            : (t =
                "UTC" === K.timezone
                  ? _e.moment.utc.apply(null, arguments)
      ...
      (q.getDefaultEventEnd = function (t, e) {
        ...
        return (
          t
            ? n.stripTime().add(q.defaultAllDayEventDuration)
            : n.add(q.defaultTimedEventDuration),
      ...
      (q.formatRange = function (t, e, n) {
        return (
          "function" == typeof n && (n = n.call(q, K, Q)),
          W(t, e, n, null, K.isRTL)
        );
      }),
              ...
              "title" == r
                ...
                : (e[r]
                    ...
                    : Ge[r] &&
                      ...
                      p.push(r)),
                  l &&
                    ((a = T(n.themeButtonIcons, r)),
                    (c = T(n.buttonIcons, r)),
                    (d = T(n.defaultButtonText, r)),
                    (u = T(n.buttonText, r)),
                    (h = u
                      ? F(u)
                      : a && n.theme
  ...
  function c(n) {
    function i(t, e) {
      return (
        !A ||
        t.clone().stripZone() < A.clone().stripZone() ||
        e.clone().stripZone() > Y.clone().stripZone()
      );
    }
    function r(t, e) {
      (A = t), (Y = e), (q = []);
    ...
    function o(e, i) {
      ...
      for (r = 0; l.length > r; r++) {
        if (
          ((s = l[r].call(N, e, A.clone(), Y.clone(), n.timezone, i)), s === !0)
        )
          return;
      ...
      if (a)
        t.isFunction(a)
          ? (y(),
            a.call(N, A.clone(), Y.clone(), n.timezone, function (t) {
              i(t), w();
            }))
          : t.isArray(a)
          ? i(a)
        ...
        if (c) {
          ...
          var g = t.extend({}, d || {}),
            p = P(e.startParam, n.startParam),
            m = P(e.endParam, n.endParam),
            v = P(e.timezoneParam, n.timezoneParam);
          p && (g[p] = A.format()),
            m && (g[m] = Y.format()),
    ...
    function f(t) {
      (t.start = N.moment(t.start)),
        t.end && (t.end = N.moment(t.end)),
        D(t),
        g(t),
        B(q);
    }
    ...
    function p(t, e) {
      ...
      if (s) {
        for (n = E(s), i = 0; n.length > i; i++)
          (r = n[i]),
            r.source || (e && (W.events.push(r), (r.source = W)), q.push(r));
        return B(q), n;
      }
      return [];
    }
    ...
    function S(i, r) {
      var s,
        ...
        c = {};
      if (
        (n.eventDataTransform && (i = n.eventDataTransform(i)),
        r && r.eventDataTransform && (i = r.eventDataTransform(i)),
        t.extend(c, i),
        r && (c.source = r),
        (c._id = i._id || (void 0 === i.id ? "_fc" + Ae++ : i.id + "")),
        ...
        k(s) && (s = e.duration(s)),
        k(o) && (o = e.duration(o)),
        i.dow || e.isDuration(s) || e.isDuration(o))
      )
        (c.start = s ? e.duration(s) : null),
          (c.end = o ? e.duration(o) : null),
          (c._recurring = !0);
      else {
        if (s && ((s = N.moment(s)), !s.isValid())) return !1;
        if (o && ((o = N.moment(o)), !o.isValid())) return !1;
        (l = i.allDay),
          void 0 === l &&
            ((a = P(r ? r.allDayDefault : void 0, n.allDayDefault)),
            (l = void 0 !== a ? a : !(s.hasTime() || (o && o.hasTime())))),
          b(s, o, l, c);
      }
      return c;
    }
    function b(t, e, i, r) {
      i
        ? (t.hasTime() && t.stripTime(), e && e.hasTime() && e.stripTime())
        : (t.hasTime() || (t = N.rezoneDate(t)),
          e && !e.hasTime() && (e = N.rezoneDate(e))),
        (r.allDay = i),
        (r.start = t),
        (r.end = e || null),
        n.forceEventDuration && !r.end && (r.end = I(r)),
        d(r);
    }
    function E(e) {
      var n,
      ...
      if (((f && g) || ((n = N.getView()), (f = n.start), (g = n.end)), e))
        if (e._recurring) {
          if ((r = e.dow)) for (i = {}, s = 0; r.length > s; s++) i[r[s]] = !0;
    ...
    function D(t, e, n) {
      ...
      return (
        ...
        (i = t.allDay != l ? t.allDay : !(e || n).hasTime()),
        i &&
          (e && (e = e.clone().stripTime()), n && (n = n.clone().stripTime())),
        e && (r = i ? C(e, a.clone().stripTime()) : C(e, a)),
        i != l
          ? (d = !0)
          : n &&
            (s = C(n || N.getDefaultEventEnd(i, e || a), e || a).subtract(
              C(c || N.getDefaultEventEnd(l, a), a)
            )),
        (o = T(v(t._id), d, i, r, s)),
        { dateDelta: r, durationDelta: s, undo: o }
      );
    }
      ...
      return (
        t.each(e, function (t, e) {
          ...
          f
            ...
            : (g.hasTime() || (g = N.rezoneDate(g)),
              p && !p.hasTime() && (p = N.rezoneDate(p))),
            p ||
              (!n.forceEventDuration && !+o) ||
              (p = N.getDefaultEventEnd(f, g)),
            g.add(s),
            p && p.add(s).add(o),
            l && (+s || +o) && (g.stripZone(), p && p.stripZone()),
            (e.allDay = f),
            (e.start = g),
            (e.end = p),
            d(e),
    ...
    function H() {
      ...
      return (
        i && (e = "object" == typeof i ? t.extend({}, r, i) : r),
        e ? E(S(e)) : []
      );
    }
    function x(t, e, i) {
      var r = t.source || {},
        s = P(t.constraint, r.constraint, n.eventConstraint),
        o = P(t.overlap, r.overlap, n.eventOverlap);
      return L(e, i, s, o, t);
    }
    function M(t, e) {
    ...
    function L(t, e, n, i, r) {
      var s, o, l, a, c;
      if (
        ((t = t.clone().stripZone()), (e = e.clone().stripZone()), null != n)
      ) {
    ...
    (N.getBusinessHoursEvents = H),
      (N.isEventAllowedInRange = x),
      (N.isSelectionAllowedInRange = M),
      (N.isExternalDragAllowedInRange = F);
  }
  function d(t) {
    (t._allDay = t.allDay),
  ...
  function y(t, e) {
    return (
      ...
      t[0].scrollHeight - 1 > t[0].clientHeight ? !0 : (w(t), !1)
    );
  }
  function w(t) {
  ...
  function D(t, e, n, i) {
    var r, s, o, l;
    return e > n && i > t
      ? (t >= n ? ((r = t.clone()), (o = !0)) : ((r = n.clone()), (o = !1)),
        i >= e ? ((s = e.clone()), (l = !0)) : ((s = i.clone()), (l = !1)),
        { start: r, end: s, isStart: o, isEnd: l })
      : void 0;
  }
  function T(t, e) {
      ...
      e.isMoment(c)
        ...
        : ((s = !1),
          ...
          d
            ? Ie.test(c)
              ? ((c += "-01"), (n = [c]), (s = !0), (o = !0))
              : (l = We.exec(c)) && ((s = !l[5]), (o = !0))
            : t.isArray(c) && (o = !0),
          (a = i ? e.utc.apply(e, n) : e.apply(null, n)),
          s
            ? ((a._ambigTime = !0), (a._ambigZone = !0))
            : r && (o ? (a._ambigZone = !0) : d && a.zone(c))),
      (a._fullCalendar = !0),
      a
    );
  }
  function N(t, e) {
    ...
    for (n = 0; t.length > n; n++)
      i.push(_e.moment.parseZone(t[n])),
        (r = r || i[n]._ambigTime),
        (s = s || i[n]._ambigZone);
  ...
  function I(t, e) {
    ...
    return "string" == typeof e
      ...
      ? Xe[n]
        ? Xe[n](t)
        : V(t, n)
      : e.maybe && ((i = B(t, e.maybe)), i.match(/[1-9]/))
      ? i
      : "";
  }
  function W(t, e, n, i, r) {
    var s;
    return (
      (t = _e.moment.parseZone(t)),
      (e = _e.moment.parseZone(e)),
  ...
  function j(t, e, n) {
    ...
    return "string" == typeof n
      ? n
      : (i = n.token) && ((r = $e[i.charAt(0)]), r && t.isSame(e, r))
      ? V(t, i)
      : !1;
  }
  function X(t) {
  ...
  var Fe = {
    ...
    _e = (t.fullCalendar = { version: "2.2.0" }),
    Ge = (_e.views = {});
  (t.fn.fullCalendar = function (e) {
    ...
    (_e.langs = Le),
    (_e.datepickerLang = function (e, n, i) {
      var r = Le[e];
      r || (r = Le[e] = {}),
        s(r, {
          isRTL: i.isRTL,
          ...
          titleFormat: {
            month: i.showMonthAfterYear
              ? "YYYY[" + i.yearSuffix + "] MMMM"
              : "MMMM YYYY[" + i.yearSuffix + "]",
          },
          defaultButtonText: {
            prev: L(i.prevText),
            next: L(i.nextText),
  ...
  (_e.moment = function () {
    ...
    (Ze.format = function () {
      return this._fullCalendar && arguments[0]
        ...
        ? V(this, "YYYY-MM-DD")
        : this._ambigZone
        ? V(this, "YYYY-MM-DD[T]HH:mm:ss")
        : je.format.apply(this, arguments);
    }),
    (Ze.toISOString = function () {
      return this._ambigTime
        ...
        : this._ambigZone
        ? V(this, "YYYY-MM-DD[T]HH:mm:ss")
        : je.toISOString.apply(this, arguments);
    }),
    ...
    (Ze.isSame = function (t, e) {
      ...
      return this._fullCalendar
        ? e
          ? ((n = N([this, t], !0)), je.isSame.call(n[0], n[1], e))
          : ((t = _e.moment.parseZone(t)),
            je.isSame.call(this, t) &&
              Boolean(this._ambigTime) === Boolean(t._ambigTime) &&
              Boolean(this._ambigZone) === Boolean(t._ambigZone))
        : je.isSame.apply(this, arguments);
    }),
    t.each(["isBefore", "isAfter"], function (t, e) {
      Ze[e] = function (t, n) {
        var i;
        return this._fullCalendar
          ? ((i = N([this, t])), je[e].call(i[0], i[1], n))
          : je[e].apply(this, arguments);
      };
    }),
    (Ve = "_d" in e() && "updateOffset" in e),
    (Oe = Ve
      ? function (t, n) {
  ...
  (q.prototype = {
    ...
    position: function () {
      ...
      (r = o.top || 0),
        ...
        u.is(window) || u.is(document)
          ? ((u = d), (e = 0), (n = 0))
          : ((i = u.offset()), (e = i.top), (n = i.left)),
        (e += d.scrollTop()),
        (n += d.scrollLeft()),
        o.viewportConstrain !== !1 &&
          ((r = Math.min(r, e + u.outerHeight() - c - this.margin)),
          (r = Math.max(r, e + this.margin)),
          (s = Math.min(s, n + u.outerWidth() - a - this.margin)),
      ...
      getCell: function (t, e) {
        ...
        if (this.inBounds(t, e)) {
          ...
          o >= 0 &&
            ...
            ((i = { row: o, col: l }),
            (i.grid = this.grid),
            (i.date = this.grid.getCellDate(i)));
        }
        return i;
      },
      ...
      dragScroll: function (t) {
        ...
        o &&
          ...
          e >= 0 && 1 >= e
            ...
            : n >= 0 && 1 >= n && (l = n * this.scrollSpeed),
          i >= 0 && 1 >= i
            ? (a = -1 * i * this.scrollSpeed)
    ...
    t.extend(ne.prototype, {
        ...
        var e,
          ...
          c = new Q(this.coordMap, {
            ...
            cellOver: function (t, s) {
              c.origDate &&
                ((i = r.getCellDayEl(t)),
                (a = [s, c.origDate].sort(x)),
                (e = a[0]),
                (n = a[1].clone().add(r.cellDuration)),
                l &&
                  (o.isSelectionAllowedInRange(e, n)
                    ? r.renderSelection(e, n)
                    : ((a = null), f())));
            },
            cellOut: function () {
            ...
            listenStop: function (t) {
              a &&
                (a[0].isSame(a[1]) && s.trigger("dayClick", i[0], e, t),
                l && s.reportSelection(e, n, t)),
                g();
            },
          });
        c.mousedown(t);
      ...
      renderRangeHelper: function (t, e, n) {
        ...
        !e &&
          ...
          (i.start = t),
          (i.end = e),
          (i.allDay = !(t.hasTime() || (e && e.hasTime()))),
          (i.className = (i.className || []).concat("fc-helper")),
          n || (i.editable = !1),
          this.renderHelper(i, n);
      },
      ...
      bgCellHtml: function (t, e, n) {
        ...
        return (
          r.unshift("fc-day", i.widgetContentClass),
          '<td class="' + r.join(" ") + '" data-date="' + n.format() + '"></td>'
        );
      },
    ...
    t.extend(ne.prototype, {
          ...
          d = new Q(s.coordMap, {
            ...
            dragStart: function (e) {
              r.triggerSegMouseout(t, e),
                (r.isDraggingSeg = !0),
                s.hideEvent(a),
                s.trigger("eventDragStart", l[0], a, e, {});
            },
            cellOver: function (e, l) {
              ...
              (n = h.start),
                (i = h.end),
                o.isEventAllowedInRange(a, n, h.visibleEnd)
                  ? s.renderDrag(n, i, t)
                    ? c.hide()
                    : c.show()
                  : ((n = null), c.show(), f());
            ...
            dragStop: function (t) {
              ...
              c.stop(!e, function () {
                (r.isDraggingSeg = !1),
                  s.destroyDrag(),
                  s.showEvent(a),
                  s.trigger("eventDragStop", l[0], a, t, {}),
                  e && s.eventDrop(l[0], a, n, t);
              }),
                g();
            },
            listenStop: function () {
      ...
      computeDraggedEventDates: function (t, e, n) {
        ...
        return (
          n.hasTime() === e.hasTime()
            ? ((i = C(n, e)),
              (r = d.clone().add(i)),
              (s = null === c.end ? null : u.clone().add(i)),
              (o = c.allDay))
            : ((r = n), (s = null), (o = !n.hasTime())),
          (l = s || a.calendar.getDefaultEventEnd(o, r)),
          { start: r, end: s, visibleEnd: l }
        );
      },
      segResizeMousedown: function (t, e) {
        ...
        (i = new Q(this.coordMap, {
          ...
          dragStart: function (e) {
            r.triggerSegMouseout(t, e),
              (r.isResizingSeg = !0),
              s.trigger("eventResizeStart", l[0], a, e, {});
          },
          cellOver: function (e, i) {
            i.isBefore(c) && (i = c),
              (u = i.clone().add(r.cellDuration)),
              o.isEventAllowedInRange(a, c, u)
                ? u.isSame(d)
                  ? ((u = null), n())
                  : (r.renderResize(c, u, t), s.hideEvent(a))
                : ((u = null), n(), f());
          },
          cellOut: function () {
            (u = null), n(), g();
          ...
          dragStop: function (t) {
            (r.isResizingSeg = !1),
              n(),
              g(),
              s.trigger("eventResizeStop", l[0], a, t, {}),
              u && s.eventResize(l[0], a, u, t);
          },
        })),
          i.mousedown(e);
      },
      ...
      eventsToInverseRanges: function (t) {
        ...
        for (o.sort(le), e = 0; o.length > e; e++)
          (n = o[e]),
            n.start > c && l.push({ event: a, start: c, end: n.start }),
            (c = n.end);
      ...
      eventRangeToSegs: function (t, e) {
        var n, i, r;
        for (
          n = e ? e(t.start, t.end) : this.rangeToSegs(t.start, t.end), i = 0;
          n.length > i;
          i++
        )
          (r = n[i]),
    ...
    t.extend(ce.prototype, {
      ...
      renderDrag: function (t, e, n) {
        ...
        return (
          ...
          n && !n.el.closest(this.el).length
            ? (this.renderRangeHelper(t, e, n),
              (i = this.view.opt("dragOpacity")),
              void 0 !== i && this.helperEls.css("opacity", i),
              !0)
            : void 0
        );
      },
    ...
    t.extend(ce.prototype, {
      ...
      destroyEvents: function () {
        this.destroySegPopover(),
          ne.prototype.destroyEvents.apply(this, arguments);
      },
      getSegs: function () {
      ...
      fgSegHtml: function (t, e) {
        ...
        return (
          ...
          !s.allDay &&
            t.isStart &&
            (d =
              '<span class="fc-time">' + F(i.getEventTimeText(s)) + "</span>"),
          (n =
            '<span class="fc-title">' +
            (F(s.title || "") || "&nbsp;") +
            "</span>"),
    ...
    t.extend(ce.prototype, {
      ...
      computeRowLevelLimit: function (t) {
        ...
        for (e = 0; s.length > e; e++)
          if (
            ((n = s.eq(e).removeClass("fc-limited")),
            n.position().top + n.outerHeight() > r)
          )
            return e;
        return !1;
      },
      limitRow: function (e, n) {
        ...
        if (n && E.segLevels.length > n) {
          for (
            s = E.segLevels[n - 1],
              o = E.cellMatrix,
              l = E.tbodyEl.children().slice(n).addClass("fc-limited").get(),
              a = 0;
            s.length > a;
            a++
          ) {
          ...
          .on("click", function (s) {
            ...
            "function" == typeof o &&
              (o = r.trigger(
                "eventLimitClick",
                null,
                { date: l, dayEl: c, moreEl: a, segs: u, hiddenSegs: h },
                s
              )),
              "popover" === o
                ? i.showSegPopover(l, e, a, u)
                : "string" == typeof o && r.calendar.zoomTo(l, o);
          });
      },
    ...
    t.extend(he.prototype, {
          ...
          (t = r.start.clone().time(c)),
            ...
            (i =
              ...
              (a && n
                ? ""
                : "<span>" +
                  F(s.formatDate(t, r.opt("axisFormat"))) +
                  "</span>") +
              "</td>"),
            (l +=
              "<tr " +
      ...
      rangeToSegs: function (t, e) {
        var n,
          ...
          a = [];
        for (
          t = t.clone().stripZone(), e = e.clone().stripZone(), i = 0;
          l.colCnt > i;
          i++
        )
          (r = l.cellToDate(0, i)),
            (s = r.clone().time(this.minTime)),
            (o = r.clone().time(this.maxTime)),
            (n = D(t, e, s, o)),
            n && ((n.col = i), a.push(n));
        return a;
      },
      ...
      buildCoords: function (n, i) {
        var r,
          ...
          c = null;
        for (
          this.dayEls.slice(0, o).each(function (e, n) {
            (r = t(n)),
              (s = r.offset().left),
              c && (c[1] = s),
              (c = [s]),
      ...
      computeTimeTop: function (t) {
        var e,
          ...
          i,
          r,
          s = (t - this.minTime) / this.slotDuration;
        return (
          (s = Math.max(0, s)),
      ...
      renderDrag: function (t, e, n) {
        ...
        return n
          ? (this.renderRangeHelper(t, e, n),
            (i = this.view.opt("dragOpacity")),
            void 0 !== i && this.helperEl.css("opacity", i),
            !0)
          : (this.renderHighlight(
              t,
      ...
      renderHelper: function (e, n) {
        var i,
          ...
          s,
          o,
          l = this.eventsToSegs([e]);
        for (
          l = this.renderFgSegEls(l), i = this.renderSegTable(l), r = 0;
          l.length > r;
          r++
        )
          (s = l[r]),
        ...
        if (n.length) {
          for (
            ...
            if (((a = r[l]), (c = t("<td/>").appendTo(o)), a.length))
              for (
                d = t('<div class="fc-' + i + '-container"/>').appendTo(c),
                  u = g.cellToDate(0, l),
                  h = 0;
                a.length > h;
                h++
    ...
    t.extend(he.prototype, {
      ...
      renderSegTable: function (e) {
        ...
        for (
          ...
          for (
            o = n[s], fe(o), l = t('<div class="fc-event-container"/>'), i = 0;
            o.length > i;
            i++
          )
            (r = o[i]),
      ...
      fgSegHtml: function (t, e) {
        ...
        return (
          ...
          s.isMultiDayEvent(o)
            ? (t.isStart || t.isEnd) &&
              ((n = s.getEventTimeText(t.start, t.end)),
              (i = s.getEventTimeText(t.start, t.end, "LT")),
              (r = s.getEventTimeText(t.start, null)))
            : ((n = s.getEventTimeText(o)),
              (i = s.getEventTimeText(o, "LT")),
              (r = s.getEventTimeText(o.start, null))),
          '<a class="' +
            c.join(" ") +
            '"' +
            (o.url ? ' href="' + F(o.url) + '"' : "") +
            ...
            (n
              ? '<div class="fc-time" data-start="' +
                ...
                "</div>"
              : "") +
            (o.title ? '<div class="fc-title">' + F(o.title) + "</div>" : "") +
            "</div>" +
            '<div class="fc-bg"/>' +
      ...
      generateSegPositionCss: function (t) {
        ...
        return (
          s && (l = Math.min(1, o + 2 * (l - o))),
          r ? ((e = 1 - l), (n = o)) : ((e = o), (n = 1 - l)),
          (a.zIndex = t.level + 1),
          (a.left = 100 * e + "%"),
          (a.right = 100 * n + "%"),
          s && t.forwardPressure && (a[r ? "marginLeft" : "marginRight"] = 20),
          a
        );
      },
    ...
    (be.prototype = {
      ...
      computeScrollerHeight: function (t) {
        var e,
          n = this.el.add(this.scrollerEl);
        return (
          n.css({ position: "relative", left: -1 }),
      ...
      documentDragStart: function (e) {
        ...
        this.opt("droppable") &&
          ...
          (t.isFunction(i) ? i.call(n[0], n) : n.is(i)) &&
            ((r = Ee(n)),
            (s = r.eventProps),
            (o = new Q(this.coordMap, {
              cellOver: function (e, n) {
                (c = n),
                  (d = r.duration ? c.clone().add(r.duration) : null),
                  (u = d || a.getDefaultEventEnd(!c.hasTime(), c)),
                  s && t.extend(s, { start: c, end: d }),
                  a.isExternalDragAllowedInRange(c, u, s)
                    ? l.renderDrag(c, u)
                    : ((c = null), f());
              },
              cellOut: function () {
            ...
            t(document).one("dragstop", function (t, e) {
              ...
              l.destroyDrag(),
                g(),
                c &&
                  (r.startTime && !c.hasTime() && c.time(r.startTime),
                  l.trigger("drop", n[0], c, t, e),
                  s &&
                    ((i = a.renderEvent(s, r.stick)),
                    l.trigger("eventReceive", null, i[0])));
            }),
            o.startDrag(e)));
      },
    ...
    (_e.dataAttrPrefix = ""),
    (De.prototype = M(be.prototype)),
    t.extend(De.prototype, {
      dayGrid: null,
      dayNumbersVisible: !1,
      ...
      numberCellHtml: function (t, e, n) {
        ...
        return this.dayNumbersVisible
          ? ((i = this.dayGrid.getDayClasses(n)),
            i.unshift("fc-day-number"),
            '<td class="' +
              i.join(" ") +
              '" data-date="' +
              n.format() +
      ...
      updateWidth: function () {
        this.weekNumbersVisible &&
          (this.weekNumberWidth = v(this.el.find(".fc-week-number")));
      },
      setHeight: function (t, e) {
        ...
        w(this.scrollerEl),
          ...
          !e &&
            y(this.scrollerEl, n) &&
            (u(this.headRowEl, b(this.scrollerEl)),
            (n = this.computeScrollerHeight(t)),
      ...
      renderEvents: function (t) {
        this.dayGrid.renderEvents(t),
          this.updateHeight(),
          be.prototype.renderEvents.call(this, t);
      },
      getSegs: function () {
        return this.dayGrid.getSegs();
      },
      destroyEvents: function () {
        be.prototype.destroyEvents.call(this),
          this.recordScroll(),
    ...
    r({ fixedWeekCount: !0 }),
    (Ge.month = Te),
    (Te.prototype = M(De.prototype)),
    t.extend(Te.prototype, {
      name: "month",
      ...
      render: function (t) {
        ...
        (this.intervalStart = t.clone().stripTime().startOf("month")),
          ...
          De.prototype.render.call(this, e, this.getCellsPerWeek(), !0);
      },
      setGridHeight: function (t, e) {
        (e = e || "variable" === this.opt("weekMode")),
          e && (t *= this.rowCnt / 6),
          p(this.dayGrid.rowEls, t, !e);
      },
    ...
    t.extend(Ce.prototype, {
      ...
      render: function (t) {
        (this.intervalStart = t.clone().stripTime().startOf("week")),
          ...
          De.prototype.render.call(this, 1, this.getCellsPerWeek(), !1);
      },
    }),
    (Ge.basicDay = He),
    (He.prototype = M(De.prototype)),
    t.extend(He.prototype, {
      name: "basicDay",
      incrementDate: function (t, e) {
      ...
      render: function (t) {
        (this.start = this.intervalStart = t.clone().stripTime()),
          ...
          De.prototype.render.call(this, 1, 1, !1);
      },
    }),
    r({
      allDaySlot: !0,
    ...
    t.extend(Me.prototype, {
      ...
      dayIntroHtml: function () {
        return (
          ...
          ">" +
          "<span>" +
          (this.opt("allDayHtml") || F(this.opt("allDayText"))) +
          "</span>" +
          "</td>"
        );
      },
      ...
      setHeight: function (t, e) {
        ...
        null === this.bottomRuleHeight &&
          ...
          w(this.scrollerEl),
          h(this.noScrollRowEls),
          this.dayGrid &&
            (this.dayGrid.destroySegPopover(),
            (n = this.opt("eventLimit")),
            n && "number" != typeof n && (n = Ue),
            n && this.dayGrid.limitRows(n)),
          e ||
            ((i = this.computeScrollerHeight(t)),
            y(this.scrollerEl, i)
              ? (u(this.noScrollRowEls, b(this.scrollerEl)),
                (i = this.computeScrollerHeight(t)),
      ...
      renderDrag: function (t, e, n) {
        return t.hasTime()
          ? this.timeGrid.renderDrag(t, e, n)
          : this.dayGrid
          ? this.dayGrid.renderDrag(t, e, n)
          : void 0;
      },
      destroyDrag: function () {
    ...
    t.extend(Re.prototype, {
      ...
      render: function (t) {
        (this.intervalStart = t.clone().stripTime().startOf("week")),
          ...
          Me.prototype.render.call(this, this.getCellsPerWeek());
      },
    }),
    (Ge.agendaDay = Pe),
    (Pe.prototype = M(Me.prototype)),
    t.extend(Pe.prototype, {
      ...
      render: function (t) {
        (this.start = this.intervalStart = t.clone().stripTime()),
          ...
          Me.prototype.render.call(this, 1);
      },
    });
});
